  ...
  <div class='home-category' @mouseleave="categoryId=null">
    <ul class="menu" >
      <li :class="{active:categoryId===item.id}" v-for="item in menuList" :key="item.id" @mouseenter="categoryId=item.id">
        ...
        <template v-else>
          <xtx-skeleton width="50px" height="21px" bg="rgb(255,255,255,0.2)" style="margin-right:5px" :animated="false"/>
          <xtx-skeleton width="60px"  height="21px" bg="rgb(255,255,255,0.2)" :animated="false"/>
        </template>
      </li>
    </ul>
    <!-- 弹层 -->
